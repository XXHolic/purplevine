  ...
  static readBuffer(buffer, options = {}, verbose = false) {
    ...
    Object.defineProperties(tags, {
      title: {
        get: function () {
          return (
            (this.v2 && (this.v2.TIT2 || this.v2.TT2)) ||
      ...
      artist: {
        get: function () {
          return (
            (this.v2 && (this.v2.TPE1 || this.v2.TP1)) ||
      ...
      album: {
        get: function () {
          return (
            (this.v2 && (this.v2.TALB || this.v2.TAL)) ||
      ...
      year: {
        get: function () {
          return (
            (this.v2 && (this.v2.TYER || this.v2.TDRC || this.v2.TYE)) ||
      ...
      genre: {
        get: function () {
          return (
            (this.v2 && (this.v2.TCON || this.v2.TCO)) ||
